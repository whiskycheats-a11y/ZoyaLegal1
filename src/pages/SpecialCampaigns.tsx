    ...
    <div>
      ...
      <section className="bg-black text-white py-20 md:py-24 border-b border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <Megaphone className="h-16 w-16 md:h-20 md:w-20 mx-auto mb-6 animate-bounce" />
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-black mb-6 tracking-tight animate-fade-in">Special Campaigns</h1>
            <p className="text-xl md:text-2xl text-gray-400 mb-4 animate-fade-in-delay">विशेष अभियान और सामुदायिक सेवाएं</p>
            ...
            {upcomingEvents.map((event, index) => (
              <div key={index} className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm hover:shadow-md transition-all">
                ...
                <div className="flex justify-between items-center">
                  <span className={`text-xs px-3 py-1 rounded-full font-medium ${event.registration === 'Open' ? 'bg-green-100 text-green-700' :
                ...
                <div className="p-6">
                  <div className="flex items-center mb-4">
                    <div className="p-3 bg-gray-100 rounded-xl mr-4 group-hover:bg-black group-hover:text-white transition-all duration-300">
                      <campaign.icon className="h-8 w-8 text-black group-hover:text-white transition-colors" />
                    </div>
                    <div>
                      <h3 className="text-lg font-black text-black">{campaign.title}</h3>
                      <p className="text-sm text-gray-600 font-bold">{campaign.hindi}</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-black text-black">{campaign.offer}</p>
                    </div>
                  </div>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {campaign.benefits.map((benefit, idx) => (
                        <span key={idx} className="bg-gray-100 text-black px-2 py-1 rounded-full text-xs font-bold border border-gray-200">
                          {benefit}
                        </span>
                      ))}
                    </div>
                  ...
                  <div className="border-t border-gray-100 pt-4">
                    <div className="flex justify-between items-center mb-3">
                      ...
                      <div className="text-right">
                        ...
                        <p className={`text-sm font-semibold ${campaign.status.includes('Active') ? 'text-green-600' :
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              { step: '1', title: 'Check Eligibility', desc: 'Review campaign requirements and eligibility criteria' },
              { step: '2', title: 'Contact Us', desc: 'Call or visit our center to register for the campaign' },
              { step: '3', title: 'Submit Documents', desc: 'Provide required documents for verification' },
              { step: '4', title: 'Avail Services', desc: 'Get the special services as per campaign benefits' }
            ].map((item, index) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center group">
              <div className="text-3xl font-black text-black mb-2 group-hover:scale-110 transition-transform">1000+</div>
              <div className="text-gray-600 font-medium">People Helped</div>
            </div>
            <div className="text-center group">
              <div className="text-3xl font-black text-black mb-2 group-hover:scale-110 transition-transform">50+</div>
              <div className="text-gray-600 font-medium">Free Campaigns</div>
            </div>
            <div className="text-center group">
              <div className="text-3xl font-black text-black mb-2 group-hover:scale-110 transition-transform">₹10L+</div>
              <div className="text-gray-600 font-medium">Value Provided</div>
            </div>
            <div className="text-center group">
              <div className="text-3xl font-black text-black mb-2 group-hover:scale-110 transition-transform">100%</div>
      ...
      <section className="py-16 bg-black text-white border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-black mb-4">Join Our Special Campaigns</h2>
